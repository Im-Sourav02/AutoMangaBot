...
class SubscriptionMonitor:
    ...
    async def process_new_chapter(self, api, task_data, chapter, users_to_update):
        ...
        # We need to process this and upload to the respective dump_channels of users.
        # However, to save bandwidth, we could download it once, convert to PDF and CBZ, and just forward/send to each.
        # But users might have custom formats. Let's keep it simple: group users by preferred format.
            ...
            async with Downloader(Config) as downloader:
                ...
                for user in users_to_update:
                    ...
                    if file_path and file_path.exists():
                        ...
                        # Note: we don't clean up the file here because another user might need the same format. 
